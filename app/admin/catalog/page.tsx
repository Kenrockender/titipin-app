      ...
      <Card className="max-h-[90vh] w-full max-w-lg overflow-auto p-6" >
        <div onClick={(e) => e.stopPropagation()}>
          ...
          <div className="flex flex-col gap-3 text-sm">
            ...
            <div className="flex items-center justify-between rounded-lg bg-brand-50 px-3 py-2 font-bold text-brand-700"><span>Final price (auto)</span><span>{formatIDR(q.totalIdr)}</span></div>
